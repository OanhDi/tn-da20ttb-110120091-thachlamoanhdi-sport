...
<title>TVU Sport Center | My Profile</title>
<!--Bootstrap -->
...
<section class="user_profile inner_pages">
  <div class="container">
    ...
    <div class="upload_user_logo"> <img src="<?php echo htmlentities($result->FlagImage); ?>" alt="<?php echo htmlentities($result->FlagName); ?>">
      </div>
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
          <h5 class="uppercase underline">Thiết lập chung</h5>
          <?php  
         if($msg){?><div class="succWrap"><strong>SUCCESS</strong>:<?php echo htmlentities($msg); ?> </div><?php }?>
          <form  method="post">
           <div class="form-group">
            ...
            <div class="form-group">
              <label class="control-label">Cập nhật gần đây  -</label>
