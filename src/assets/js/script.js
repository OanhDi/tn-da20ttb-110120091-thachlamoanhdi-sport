...
async function fetchMatch() {
    ...
    let data = await fetch('match-schedule/getmatch-schedule.php');
    ...
    function randerDom(match, selector) {
        ...
        <div class="match-info">
            <h5 class="group">${match.group}</h5>
            <h5>Match Number<span class="badge">${match.matchNumber}</span> </h5>
        </div>
        <div class="flags">
            <div class="home-flag">
                <img src="${match.home_flag}" alt="${match.home_team}" class="flag" />
            <h5 class="home-team">${match.home_team}</h5>
            </div>
            <span class="vs1">
            VS
            </span>
            ...
            <h5 class="home-team">${match.away_team}</h5>
            </div>
        </div>
        <div class="time-area">
            <div class="time">
                <h6 class="month">${match.month}</h6>
                <h6 class="day">${match.day}</h6>
                <h6 class="date">${match.date}</h6>
            </div>
            <h6 class="match-time">${match.localTime}</h6>
        </div>
     </div>
  `;
//   console.log(match.away_flag + ':' + match.away_team);
    }
