...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_REQUEST['eid'])) {
		...
		$msg = "Đã Vô Hiệu Hóa Lời Chứng Thực Thành Công";
	}
	...
	if (isset($_REQUEST['aeid'])) {
		...
		$msg = "Lời Chứng Thực Đã Kích Hoạt Thành Công";
	}
	...
	<head>
		...
		<title>TVU Sport Center |Admin Manage testimonials </title>
				...
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<h2 class="page-title">Quản Lý Lời Chứng Thực</h2>

							<!-- Zero Configuration Table -->
							<div class="panel panel-default">
								<div class="panel-heading">Lời Chứng Thực của Người Dùng</div>
													...
													<tr>
														...
														<td><?php if ($result->status == "" || $result->status == 0) {
															?><a href="testimonials.php?aeid=<?php echo htmlentities($result->id); ?>"
																	onclick="return confirm('Bạn có thực sự muốn kích hoạt không?')">
																	Inactive</a>
															<?php } else { ?>

																<a href="testimonials.php?eid=<?php echo htmlentities($result->id); ?>"
																	onclick="return confirm('Bạn có thực sự muốn vô hiệu hóa không?')">
																	Active</a>
															</td>
														<?php } ?></td>
													</tr>
