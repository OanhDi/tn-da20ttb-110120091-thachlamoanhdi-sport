...
try {
    ...
    $BookingDate = $_POST['BookingDate'] === 'null' ? NULL : $_POST['BookingDate'];
...
LEFT JOIN tblmatchpayments mp ON mp.MatchID = m.MatchID
WHERE bk.Status IN ('3','4') AND bk.BookingDate = IFNULL(:BookingDate, bk.BookingDate) 
