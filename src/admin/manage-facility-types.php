...
if (strlen($_SESSION['alogin']) == 0) {
	...
	<head>
		...
		<title>TVU Sport Center |Admin Manage Facility Type </title>
				...
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<h2 class="page-title">Danh Mục Cơ Sở Vật Chất</h2>
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									...
									<?php } else if ($msg) { ?>
											...
											<script>
												setTimeout(function () {
													window.location.href = 'manage-facility-type.php';
									...
									<div class="row mb-4">
										<div class="col-md-12">
											<div class="form-group">
												<label for="typename">Tên Cơ Sở Vật Chất</label>
									...
									<table id="zctb" class="display table table-striped table-bordered table-hover"
										...
										<tbody>
											...
											<?php $sql = "SELECT * FROM tblfacility_types";
											$query = $dbh->prepare($sql);
											$query->execute();
											...
											if ($query->rowCount() > 0) {
												foreach ($results as $result) {
													...
													<tr>
														...
														<td><?php echo htmlentities($result->Create_By); ?></td>
														<td><a href="edit-facility-type.php?id=<?php echo $result->id; ?>"><i
																	class="fa fa-edit"></i></a>&nbsp;&nbsp;
															<a href="manage-facility-type.php?del=<?php echo $result->id; ?>"
