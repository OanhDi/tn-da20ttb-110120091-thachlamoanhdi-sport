...
try {
    ...
    $sql = "SELECT DATE_FORMAT(a.CreateDate, '%Y') AS Year_Revenue, 
...
WHERE a.id_description = IFNULL(:Revenue, a.id_description)
  AND YEAR(a.CreateDate) BETWEEN IFNULL(:startDate, YEAR(a.CreateDate)) 
                        AND IFNULL(:endDate, YEAR(a.CreateDate))
GROUP BY DATE_FORMAT(a.CreateDate, '%Y'), a.Description
ORDER BY DATE_FORMAT(a.CreateDate, '%Y'), a.Description
";
