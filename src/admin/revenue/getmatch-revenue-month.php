...
try {
    ...
    $sql = "SELECT DATE_FORMAT(a.CreateDate, '%m-%Y') AS MonthYear, 
...
GROUP BY DATE_FORMAT(a.CreateDate, '%m-%Y'), id_description
ORDER BY DATE_FORMAT(a.CreateDate, '%Y-%m'), id_description;
";
