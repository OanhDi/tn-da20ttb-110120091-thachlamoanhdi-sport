...
if (strlen($_SESSION['alogin']) == 0) {
	...
	<head>
		...
		<title>TVU Sport Center |Admin Manage Queries </title>
				...
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<h2 class="page-title">Quản Lý Các Yêu Cầu Liên Hệ Với Chúng Tôi</h2>

							<!-- Zero Configuration Table -->
							<div class="panel panel-default">
								<div class="panel-heading">Yêu Cầu Của Người Dùng</div>
													...
													<tr>
														...
														<?php } else { ?>
															...
															<td><a href="manage-conactusquery.php?eid=<?php echo htmlentities($result->id); ?>"
																	onclick="return confirm('Bạn có thực sự muốn đọc không?')">Pending</a>
															</td>
														<?php } ?>
													</tr>
													<?php $cnt = $cnt + 1;
