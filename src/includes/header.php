    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-3 col-md-2">
          <div class="logo"> <a href="index.php"><img src="assets/images/logotvu.png" alt="image" width="100" height="100"/></a> </div>
        </div>
        <div class="col-sm-9 col-md-10">
          <div class="header_info">
            ...
            <?php } else {
              ...
              echo "Welcome To TVU Sport Center";
            } ?>
          </div>
        </div>
      </div>
    ...
    <div class="container">
            ...
            <li class="dropdown"> <a href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i
              ...
              <ul class="dropdown-menu">
                <?php if ($_SESSION['login']) { ?>
                  <li><a href="profile.php">Thiết lập Hồ sơ</a></li>
                  <li><a href="update-password.php">Thay Đổi Mật Khẩu</a></li>
                  <li><a href="my-booking.php">Quản Lý Đặt Sân</a></li>
      ...
      <div class="collapse navbar-collapse" id="navigation">
        <ul class="nav navbar-nav">
          ...
          <li><a href="listTeam.php">Đội Bóng</a></li>
          <li><a href="match-schedule.php">Lịch Thi Đấu</a>
          <li><a href="booking.php">Đặt Sân</a></li>
          <!-- <li><a href="page.php?type=faqs">Đặt Lịch Thi Đấu</a></li> -->
          <li><a href="RankTeam.php">Bảng Xếp Hạng</a></li>
