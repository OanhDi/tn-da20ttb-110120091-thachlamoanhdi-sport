...
if (isset($_POST['update'])) {
  ...
  if ($query->rowCount() > 0) {
    ...
    echo "<script>alert('Địa chỉ email hoặc số điện thoại không hợp lệ');</script>";
  }
}
            ...
            <div class="col-md-12">
              <form name="chngpwd" method="post" onSubmit="return valid();">
                <div class="form-group">
                  <input type="email" name="email" class="form-control" placeholder="Địa chỉ mail*" required="">
                </div>
                <div class="form-group">
                  <input type="text" name="mobile" class="form-control" placeholder="Điện Thoại*" required="">
                </div>
                <div class="form-group">
              ...
              <div class="text-center">
                <p class="gray_text">Vì lý do bảo mật, chúng tôi không lưu trữ mật khẩu của bạn. Mật khẩu của bạn sẽ
                  được đặt lại và một mật khẩu mới sẽ được gửi.</p>
                <p><a href="#loginform" data-toggle="modal" data-dismiss="modal"><i class="fa fa-angle-double-left"
                      aria-hidden="true"></i> Quay lại Đăng nhập</a></p>
              </div>
            </div>
          </div>
        </div>
