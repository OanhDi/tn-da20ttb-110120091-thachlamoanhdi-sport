...
<head>
    <meta charset="UTF-8">
    <title>TVU Sport Center | List Team</title>
    <!--Bootstrap -->
    ...
    <section class="listing-detail">
        <div class="container">
            <div class="container mt-5">
                <h2 class="mb-4">Danh sách đội bóng</h2>
                        ...
                        try {
                            ...
                            if (data && data.length > 0) {
                                data.forEach((result, index) => {
                                    const email = result.Email === null ? '' : result.Email;
                                    const Country = result.Country === null ? '' : result.Country;
                                    const Rank = result.Rank === null ? '' : result.Rank;
                                    const MemberCount = result.MemberCount === null ? '' : result.MemberCount;
                                    const column = `<tr>
