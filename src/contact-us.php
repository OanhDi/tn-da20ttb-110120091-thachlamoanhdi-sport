...
if($lastInsertId)
{
$msg="Yêu cầu đã được gửi. Chúng tôi sẽ liên hệ với bạn sớm";
}
else 
{
...
<title>TVU Sport Center | Contact Us Page</title>
<!--Bootstrap -->
...
<section class="contact_us section-padding">
  <div class="container">
    <div  class="row">
      <div class="col-md-6">
        <h4>Liên hệ với chúng tôi bằng cách sử dụng biểu mẫu dưới đây</h4>
        ...
        <div class="contact_form gray-bg">
          <form  method="post">
            ...
            <div class="form-group">
              <label class="control-label">Địa Chỉ Mail <span>*</span></label>
...
{ ?>
          <ul>
            ...
            <li>
              ...
              <div class="contact_info_m"><a href="tel:00-1234-567-89"><?php   echo htmlentities($result->ContactNo); ?></a></div>
            </li>
            <li>
